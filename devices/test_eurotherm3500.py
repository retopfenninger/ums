...
This Python file was changed (committed) at $Date: 2012-01-06 01:11:16 +0100 (Fri, 06 Jan 2012) $, 
...
__date__      = "$Date: 2012-01-06 01:11:16 +0100 (Fri, 06 Jan 2012) $"
...
class TestDummyCommunication(unittest.TestCase):
    ...
    def setUp(self):   
        ...
        self.instrument = eurotherm3500.Eurotherm3500('/dev/ttyS1', 1)
